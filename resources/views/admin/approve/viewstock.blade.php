...
<?php
        $approvename = Session::get('admin_name');
        ...
        <div class="col-lg-12">
            <div class="panel panel-disabled">
                ...
                <div class="panel-body">
                    <div class="row">
                        <form role="form" action="{{ url('approvestockin/'.$stcInData->id) }}" method="post">
                            {{ csrf_field() }}
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="hidden" name="approvedby" id="approvedby" value="<?php echo $approvename; ?>">

                                <button type="submit" class="btn btn-primary"> Approve StockIn</button>
